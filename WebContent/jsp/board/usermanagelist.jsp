			...
			<div class="panel bg-white border-none">
				<div class="panel-body">
					...
					<table id="datatables-example"
						...
						<tbody>
							<tr>
								<td><input width="5%" type="checkbox" class="icheck" name="checkbox1" /></td></td>
								<td width="10%"><h6>1</h6></td>
								<td width="50%"><h6>회시장소안내</h6></td>
								<td width="10%"><h6>김미희</h6></td>
								<td width="15%"><h6>2016.02.11</h6></td>
								<td width="10%"><h6>3</h6></td>
